...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="py-20 md:py-24 px-5 sm:px-6 relative overflow-hidden bg-[#050508]"
    >
      {/* BACKGROUND GLOW */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20 lg:mb-24">
          ...
          <motion.div
            ...
            className="relative group lg:order-1 order-2 mt-10 lg:mt-0"
          >
            {/* DARK GLOW */}
            <div className="absolute inset-0 bg-violet-500/20 blur-[120px] rounded-full" />

            <div className="relative z-10 bg-white/5 backdrop-blur-xl border border-white/10 p-3 rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden">

              <img
                src={aboutImage}
                alt="Parth Prajapati"
                className="w-full aspect-[4/5] object-cover rounded-[1.5rem] sm:rounded-[2rem] transition-all duration-700 hover:scale-105"
                style={{
                  filter: 'none',
                  mixBlendMode: 'normal',
                }}
          ...
          <div className="text-center lg:text-left">
            ...
            <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-white leading-tight">
              Turning Complex Ideas <br />
              Into <span className="text-cyan-400 italic">Digital Reality</span>
            </h3>

            <p className="text-base sm:text-lg text-zinc-400 leading-relaxed mb-6 font-light">
            ...
            <p className="text-base sm:text-lg text-zinc-500 leading-relaxed mb-10 italic">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
              {stats.map((stat) => (
                <div key={stat.label} className="group cursor-default">
                  <h4 className="text-2xl sm:text-3xl font-bold text-white mb-2 group-hover:text-gradient transition-all">
                    {stat.value}
                  </h4>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          {[
            ...
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl hover:bg-white/10 hover:-translate-y-1 transition-all duration-500"
            >
              <div
                className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 ${item.color} transition-transform group-hover:scale-110`}
              >
                {item.icon}
              </div>
